...
from utils.api_utils import timeout
from utils.picture import vision_llm_chunk as picture_vision_llm_chunk
from utils.prompts import vision_llm_figure_describe_prompt
    ...
    def _extract_figures_info(self, figures_data):
        ...
        for item in figures_data:
            ...
            if (
                ...
                assert len(item) == 2 and isinstance(item[0], Image.Image) and isinstance(item[1], list), (
